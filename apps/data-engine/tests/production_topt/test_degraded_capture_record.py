...
Split per #906 to eliminate the monolithic CI wall:
- Observation reuse and boundary tests moved to test_degraded_capture_reuse.py.
- Forced fetch and run-scoped reader tests moved to test_degraded_capture_forced.py.
